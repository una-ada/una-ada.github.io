const alpha = Array.from({ length: 26 }, (_, i) => String.fromCharCode(97 + i)),
  icons = {
    ...
    apple_podcasts: 'apple_podcasts.png',
    asset: 'asset.png',
    audacity: 'audacity.png',
    audible: 'audible.png',
    backtracks: 'backtracks.png',
    ...
    google_podcasts: 'google_podcasts.png',
    graphql: 'graphql.png',
    haskell: 'hs.png',
    handlebars: 'hbs.png',
    heroku: 'heroku.png',
    ...
    oauth: 'oauth.png',
    php: 'php.png',
    playerfm: 'playerfm.png',
    pocket_casts: 'pocket_casts.png',
    podbay: 'podbay.png',
    podcast: 'aud.png',
    podchaser: 'podchaser.png',
    podyssey: 'podyssey.png',
    postgresql: 'postgresql.png',
    programming: 'pc.png',
    pug: 'pug.png',
    python: 'py.png',
    radio_public: 'radio_public.png',
    qobuz: 'qobuz.png',
    react: 'react.png',
    scss: 'sass.png',
