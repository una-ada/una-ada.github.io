...
// stage content:
(lib.planettophiblue = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(1).to({_off:false},0).to({_off:true},1).wait(28));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_2).wait(2).to({_off:false},0).to({_off:true},1).wait(27));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_3).wait(3).to({_off:false},0).to({_off:true},1).wait(26));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_4).wait(4).to({_off:false},0).to({_off:true},1).wait(25));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_5).wait(5).to({_off:false},0).to({_off:true},1).wait(24));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_6).wait(6).to({_off:false},0).to({_off:true},1).wait(23));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_7).wait(7).to({_off:false},0).to({_off:true},1).wait(22));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_8).wait(8).to({_off:false},0).to({_off:true},1).wait(21));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_9).wait(9).to({_off:false},0).to({_off:true},1).wait(20));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_10).wait(10).to({_off:false},0).to({_off:true},1).wait(19));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_11).wait(11).to({_off:false},0).to({_off:true},1).wait(18));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_12).wait(12).to({_off:false},0).to({_off:true},1).wait(17));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_13).wait(13).to({_off:false},0).to({_off:true},1).wait(16));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_14).wait(14).to({_off:false},0).to({_off:true},1).wait(15));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_15).wait(15).to({_off:false},0).to({_off:true},1).wait(14));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_16).wait(16).to({_off:false},0).to({_off:true},1).wait(13));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_17).wait(17).to({_off:false},0).to({_off:true},1).wait(12));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_18).wait(18).to({_off:false},0).to({_off:true},1).wait(11));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_19).wait(19).to({_off:false},0).to({_off:true},1).wait(10));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_20).wait(20).to({_off:false},0).to({_off:true},1).wait(9));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_21).wait(21).to({_off:false},0).to({_off:true},1).wait(8));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_22).wait(22).to({_off:false},0).to({_off:true},1).wait(7));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_23).wait(23).to({_off:false},0).to({_off:true},1).wait(6));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_24).wait(24).to({_off:false},0).to({_off:true},1).wait(5));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_25).wait(25).to({_off:false},0).to({_off:true},1).wait(4));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_26).wait(26).to({_off:false},0).to({_off:true},1).wait(3));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_27).wait(27).to({_off:false},0).to({_off:true},1).wait(2));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_28).wait(28).to({_off:false},0).to({_off:true},1).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_29).wait(29).to({_off:false},0).wait(1));
...
p.nominalBounds = new cjs.Rectangle(102.7,167.6,204.9,204.8);
// library properties:
lib.properties = {
